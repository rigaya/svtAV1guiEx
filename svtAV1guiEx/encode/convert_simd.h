...
template <BOOL aligned_store>
static __forceinline void convert_yc48_to_nv12_highbit_simd(void *pixel, CONVERT_CF_DATA *pixel_data, const int width, const int height, const int LSFT_YCC, const __m128i &xC_Y_L_MA, const int Y_L_RSH, const __m128i &xC_UV_L_MA_420P, int UV_L_RSH_420P) {
    int x, y;
    ...
    for (y = 0; y < height; y += 2) {
        ...
        for (x = 0; x < width; x += 8, ycp += 24, ycpw += 24) {
            ...
            _mm_store_switch_si128((__m128i *)(Y + x), convert_y_range_from_yc48(x1, xC_Y_L_MA, Y_L_RSH, xC_YCC, xC_pw_one));
            ...
            _mm_store_switch_si128((__m128i *)(Y + x + width), convert_y_range_from_yc48(x1, xC_Y_L_MA, Y_L_RSH, xC_YCC, xC_pw_one));

            x0 = convert_uv_range_from_yc48_yuv420p(x0, x2, _mm_set1_epi16(UV_OFFSET_x2), xC_UV_L_MA_420P, UV_L_RSH_420P, xC_YCC, xC_pw_one);
...
static __forceinline void convert_yc48_to_nv12_10bit_simd(void *pixel, CONVERT_CF_DATA *pixel_data, const int width, const int height) {
    convert_yc48_to_nv12_highbit_simd<aligned_store>(pixel, pixel_data, width, height, LSFT_YCC_10, xC_Y_L_MA_10, Y_L_RSH_10, xC_UV_L_MA_10_420P, UV_L_RSH_10_420P);
}
...
static __forceinline void convert_yc48_to_nv12_16bit_simd(void *pixel, CONVERT_CF_DATA *pixel_data, const int width, const int height) {
    convert_yc48_to_nv12_highbit_simd<aligned_store>(pixel, pixel_data, width, height, LSFT_YCC_16, xC_Y_L_MA_16, Y_L_RSH_16, xC_UV_L_MA_16_420P, UV_L_RSH_16_420P);
}

template <BOOL aligned_store>
static __forceinline void convert_yc48_to_nv12_i_highbit_simd(void *pixel, CONVERT_CF_DATA *pixel_data, const int width, const int height, const int LSFT_YCC, const __m128i &xC_Y_L_MA, const int Y_L_RSH, const __m128i xC_UV_L_MA_420I[2], int UV_L_RSH_420I) {
    int x, y, i;
    short *dst_Y = (short *)pixel_data->data[0];
    short *dst_C = (short *)pixel_data->data[1];
    short *ycp, *ycpw;
    ...
    for (y = 0; y < height; y += 4) {
        for (i = 0; i < 2; i++) {
            ...
            for (x = 0; x < width; x += 8, ycp += 24, ycpw += 24) {
                ...
                x3 = _mm_loadu_si128((__m128i *)(ycpw + 16));
                gather_y_uv_from_yc48(x1, x2, x3);
                _mm_store_switch_si128((__m128i *)(Y + x + width*2), convert_y_range_from_yc48(x1, xC_Y_L_MA, Y_L_RSH, xC_YCC, xC_pw_one));

                _mm_store_switch_si128((__m128i *)(C + x), convert_uv_range_from_yc48_420i(x0, x2, _mm_set1_epi16(UV_OFFSET_x1), xC_UV_L_MA_420I[2*i], xC_UV_L_MA_420I[((i+1)&0x01)*2], UV_L_RSH_420I, xC_YCC, xC_pw_one));
            }
        }
    }
}
...
static __forceinline void convert_yc48_to_nv12_i_10bit_simd(void *pixel, CONVERT_CF_DATA *pixel_data, const int width, const int height) {
    convert_yc48_to_nv12_i_highbit_simd<aligned_store>(pixel, pixel_data, width, height, LSFT_YCC_10, xC_Y_L_MA_10, Y_L_RSH_10, (const __m128i *)Array_UV_L_MA_10_420I, UV_L_RSH_10_420I);
}
...
static __forceinline void convert_yc48_to_nv12_i_16bit_simd(void *pixel, CONVERT_CF_DATA *pixel_data, const int width, const int height) {
    convert_yc48_to_nv12_i_highbit_simd<aligned_store>(pixel, pixel_data, width, height, LSFT_YCC_16, xC_Y_L_MA_16, Y_L_RSH_16, (const __m128i *)Array_UV_L_MA_16_420I, UV_L_RSH_16_420I);
}

template <BOOL aligned_store>
static __forceinline void convert_yc48_to_yv12_highbit_simd(void *pixel, CONVERT_CF_DATA *pixel_data, const int width, const int height, const int LSFT_YCC, const __m128i &xC_Y_L_MA, const int Y_L_RSH, const __m128i &xC_UV_L_MA_420P, int UV_L_RSH_420P) {
    int x, y;
    short *dst_Y = (short *)pixel_data->data[0];
    ...
    for (y = 0; y < height; y += 2) {
        ...
        for (x = 0; x < width; x += 16, ycp += 48, ycpw += 48) {
            ...
            x4 = convert_uv_range_from_yc48_yuv420p(x0, x2, _mm_set1_epi16(UV_OFFSET_x2), xC_UV_L_MA_420P, UV_L_RSH_420P, xC_YCC, xC_pw_one);
            ...
            _mm_store_switch_si128((__m128i *)(Y + x + 8), convert_y_range_from_yc48(x1, xC_Y_L_MA, Y_L_RSH, xC_YCC, xC_pw_one));
            ...
            _mm_store_switch_si128((__m128i *)(Y + x + 8 + width), convert_y_range_from_yc48(x1, xC_Y_L_MA, Y_L_RSH, xC_YCC, xC_pw_one));
...
static __forceinline void convert_yc48_to_yv12_10bit_simd(void *pixel, CONVERT_CF_DATA *pixel_data, const int width, const int height) {
    convert_yc48_to_yv12_highbit_simd<aligned_store>(pixel, pixel_data, width, height, LSFT_YCC_10, xC_Y_L_MA_10, Y_L_RSH_10, xC_UV_L_MA_10_420P, UV_L_RSH_10_420P);
}
...
static __forceinline void convert_yc48_to_yv12_16bit_simd(void *pixel, CONVERT_CF_DATA *pixel_data, const int width, const int height) {
    convert_yc48_to_yv12_highbit_simd<aligned_store>(pixel, pixel_data, width, height, LSFT_YCC_16, xC_Y_L_MA_16, Y_L_RSH_16, xC_UV_L_MA_16_420P, UV_L_RSH_16_420P);
}

template <BOOL aligned_store>
static __forceinline void convert_yc48_to_yv12_i_highbit_simd(void *pixel, CONVERT_CF_DATA *pixel_data, const int width, const int height, const int LSFT_YCC, const __m128i &xC_Y_L_MA, const int Y_L_RSH, const __m128i xC_UV_L_MA_420I[2], int UV_L_RSH_420I) {
    int x, y, i;
    short *dst_Y = (short *)pixel_data->data[0];
    short *dst_U = (short *)pixel_data->data[1];
    short *dst_V = (short *)pixel_data->data[2];
    ...
    for (y = 0; y < height; y += 4) {
        for (i = 0; i < 2; i++) {
            ...
            for (x = 0; x < width; x += 16, ycp += 48, ycpw += 48) {
                ...
                x4 = convert_uv_range_from_yc48_420i(x0, x2, _mm_set1_epi16(UV_OFFSET_x1), xC_UV_L_MA_420I[2*i], xC_UV_L_MA_420I[((i+1)&0x01)*2], UV_L_RSH_420I, xC_YCC, xC_pw_one);
                ...
                x3 = _mm_loadu_si128((__m128i *)(ycpw + 40));
                gather_y_uv_from_yc48(x1, x2, x3);
                _mm_store_switch_si128((__m128i *)(Y + x + 8 + width*2), convert_y_range_from_yc48(x1, xC_Y_L_MA, Y_L_RSH, xC_YCC, xC_pw_one));

                x0 = convert_uv_range_from_yc48_420i(x0, x2, _mm_set1_epi16(UV_OFFSET_x1), xC_UV_L_MA_420I[2*i], xC_UV_L_MA_420I[((i+1)&0x01)*2], UV_L_RSH_420I, xC_YCC, xC_pw_one);
...
static __forceinline void convert_yc48_to_yv12_i_10bit_simd(void *pixel, CONVERT_CF_DATA *pixel_data, const int width, const int height) {
    convert_yc48_to_yv12_i_highbit_simd<aligned_store>(pixel, pixel_data, width, height, LSFT_YCC_10, xC_Y_L_MA_10, Y_L_RSH_10, (const __m128i *)Array_UV_L_MA_10_420I, UV_L_RSH_10_420I);
}
...
static __forceinline void convert_yc48_to_yv12_i_16bit_simd(void *pixel, CONVERT_CF_DATA *pixel_data, const int width, const int height) {
    convert_yc48_to_yv12_i_highbit_simd<aligned_store>(pixel, pixel_data, width, height, LSFT_YCC_16, xC_Y_L_MA_16, Y_L_RSH_16, (const __m128i *)Array_UV_L_MA_16_420I, UV_L_RSH_16_420I);
}
